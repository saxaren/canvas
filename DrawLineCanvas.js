...
const DrawLineCanvas = forwardRef(({ clearCanvas, fetchUrl }, ref) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <View> */}
      <Button title="Ladda former" onPress={fetchShapes} />

      {/* <Button title="drawRectangles" onPress={() => drawShape(shapes[0])} /> */}
      {shapes && (
        ...
        // <Pressable onPress={() => drawShape(shapes[1])}>
        //   <Text>Rita {shapes[1]?.type}</Text>
        // </Pressable> />
      )}
      {/* </View> */}
